...
!=======================================================================================================
     ...
     3 PROPS(NPROPS),COORDS(3),DROT(3,3),DFGRD0(3,3),DFGRD1(3,3)
      ...
      if(statev(1)>props(6)) statev(1)=props(6)
...
!<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
     ...
     &                         + dstranU(3))*(1.0d0+statev(1))
          ...
          if(Mstatev(1)>props(6)) Mstatev(1)=props(6)
          if(Mstatev(1)<props(5)) Mstatev(1)=props(5) 
...
!<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
     ...
     &                          stress_visc,CMATRIX)
        ...
        if (dtime<1.0d-8.or.kstep==1) dtime=1.0d0
      ...
      statev(5+ntens+ntens:4+3*ntens) = stress
